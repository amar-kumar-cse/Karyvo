...
export function InteractiveBulletDemo() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <GlassCard variant="interactive" className="p-6 sm:p-8 rounded-3xl space-y-6">
        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-5">
          <div>
            <div className="flex items-center gap-2">
              <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
              <span className="text-xs font-bold uppercase tracking-wider text-indigo-600 font-heading">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch">
          ...
          <div className="space-y-2 p-4 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] text-slate-500 font-medium">Unquantified & Passive</span>
              </div>
              <textarea
                value={inputBullet}
                onChange={(e) => setInputBullet(e.target.value)}
                rows={3}
                className="w-full bg-transparent text-xs text-slate-800 placeholder-slate-400 resize-none outline-none focus:ring-0 leading-relaxed font-sans"
          ...
          <div className="space-y-2 p-4 rounded-2xl bg-indigo-50/70 border border-indigo-200 flex flex-col justify-between shadow-sm">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] text-emerald-700 font-mono font-bold bg-emerald-100 px-1.5 py-0.5 rounded border border-emerald-200">
                  ATS Score: 98%
                </span>
              </div>
            ...
            <div className="pt-3 border-t border-indigo-200/60 flex items-center justify-between">
              <div className="flex items-center gap-2 text-[10px] text-indigo-700 font-semibold">
                <span className="px-1.5 py-0.5 rounded bg-indigo-100 text-indigo-800 border border-indigo-200">Action Verbs</span>
                <span className="px-1.5 py-0.5 rounded bg-amber-100 text-amber-800 border border-amber-200">Metrics %</span>
                <span className="px-1.5 py-0.5 rounded bg-emerald-100 text-emerald-800 border border-emerald-200">Tech Scope</span>
              </div>
