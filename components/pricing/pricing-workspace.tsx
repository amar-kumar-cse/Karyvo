  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      ...
      <div className="text-center space-y-3">
        <GlassBadge variant="gold" className="text-xs font-semibold px-3 py-1">
          India-First Pricing
        </GlassBadge>
        ...
        <div
          ...
          className="inline-flex items-center p-1 rounded-full bg-slate-100/90 border border-slate-200/80 shadow-inner backdrop-blur-md mt-4"
        >
          <button
            role="radio"
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold transition-all ${
              billingCycle === "yearly"
                ? "bg-amber-400 text-slate-950 shadow-sm font-bold border border-amber-300"
                : "text-slate-600 hover:text-slate-900 hover:bg-white/50"
            }`}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
        ...
        <GlassCard variant="default" className="p-8 rounded-3xl flex flex-col justify-between space-y-8">
          <div className="space-y-6">
            <div className="space-y-1">
              <GlassBadge variant="default" className="text-xs font-semibold text-slate-600">
                Starter
              </GlassBadge>
              <h2 className="font-heading text-2xl font-bold text-slate-900 mt-2">Free Tier</h2>
            ...
            <ul className="space-y-3.5 text-xs text-slate-700 pt-5 border-t border-slate-200">
              ...
              <li className="flex items-center gap-2.5">
                <Check className="h-4 w-4 text-emerald-600 shrink-0" />
                <span>3 AI Bullet Improvements / day with STAR Framework</span>
              </li>
              <li className="flex items-center gap-2.5">
                <Check className="h-4 w-4 text-emerald-600 shrink-0" />
                <span>Standard Clean PDF Print & Download Capabilities</span>
              </li>
            </ul>

            <div className="p-3.5 rounded-xl bg-slate-50/80 border border-slate-200 text-xs text-slate-600 flex items-center gap-2">
              <ShieldCheck className="h-4 w-4 text-slate-500 shrink-0" />
              <span>No credit card required • Free forever account</span>
            </div>
          </div>
        ...
        <GlassCard variant="gold" className="p-8 rounded-3xl relative flex flex-col justify-between space-y-8">
          <div className="space-y-6">
            <div className="space-y-1">
              <GlassBadge variant="gold" className="text-xs font-semibold flex items-center gap-1.5">
                <Crown className="h-3.5 w-3.5 text-amber-600 fill-amber-500/20" />
                Premium Career Engine
              </GlassBadge>
              <h2 className="font-heading text-3xl font-extrabold text-slate-900 mt-2">Karyvo Pro</h2>
